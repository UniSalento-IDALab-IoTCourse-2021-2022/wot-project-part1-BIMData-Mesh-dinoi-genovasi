...
mqttClient = new Paho.MQTT.Client(hostname, port,"bimUserAgent");
...
function Connected() {
    console.log("Connected: "+elementUUID);
    mqttClient.subscribe("BIMData_Architecture/Computer_Engineering_Cloud/IOT_Project/RTLS_MESH_NETWORK_IFC/Ecotekne/LaStecca/PrimoPiano/Idalab-002/Desk/uuid/"+elementUUID);
}
...
function geoInit(sub){
    ...
    var parameters = {
        ...
        "appletOnLoad":function(api){drawPoints(api)},
